...
function calc(){
    ...
    else
    {
        ...
        let selectconvenio = document.querySelector(".form-select").value;

        if(selectconvenio != ""){
            precoFinal = precoFinal - (precoFinal*(selectconvenio/100));
        }
        ...
        saida.innerHTML += "<br>";
        if(selectconvenio != ""){
            saida.innerHTML += `Você recebeu ${selectconvenio}% de desconto`;
        }
        saida.innerHTML += "<br>";
        saida.innerHTML += "<br>"; 
